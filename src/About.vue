...
<template>
    <main>
        ...
        <div class="main_about">
            <span>A few things I know about "Ego"</span>
            <p class="first_para">
            ...
            <p class="second_para">
                ...
                <span>
                    2. **Superego**: The "Superego" represents the conscious part of the mind containing societal rules, values, and standards. It develops through learning from family, society, and culture, and helps restrain and shape behavior according to moral principles and laws.
                </span>
                <span>
                    3. **Ego**: The "Ego" serves as the intermediary between the "id" and "superego," tasked with regulating and balancing the primal needs of the "id" with the societal norms of the "superego." The ego is the part of the mind that operates based on the principles of reality and practicality, striving to fulfill the needs of the "id" in a safe and socially acceptable manner.
                </span>
            </p>

            <p class="third_para">
                "Master of the Human: Ego" could be translated as "Authority of the Human: Ego." In this context, "Ego" can be understood as a part of the human self, representing self-awareness and consciousness, as well as as well as arrogance. This title may imply the autonomy, confidence, and willpower of humans, manifested through the strength and authority of the "ego." In some cases, this could imply the self-possession, initiative, and self-determination of individuals in their lives, not overly influenced by external factors.
